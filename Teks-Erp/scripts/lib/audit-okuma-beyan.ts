...
export const AUDIT_GOC_ISTISNALARI: readonly GocIstisnasi[] = [
  ...
  { dosya: "scripts/backfill_workorder_events.ts", tarih: "2026-09-25", durum: "ONAYLI",
    hedef: "WorkOrderEvent (channel=BACKFILL) + WorkOrderCloseSnapshot (closeKind=BACKFILL) — hareket defteri D7",
    gerekce: "defter (2026-09-26 migration) öncesi renk/en/tip/değiştir-yaz/elle kapanış geçmişi yalnız audit'te; açılış ve iptal kolonlardan, tamamlanma son adım bitişinden YAKLAŞIK (S5 = A); yayın günü bir kez, CREATED'lı iş emri atlanır" },
