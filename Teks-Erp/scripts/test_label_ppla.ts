...
function main() {
  ...
  // <STX>M artık gövde boyu DEĞİL, TOF tavanı (gövde+gap ~1.5× / ≥5"): 148mm+3gap → 0645.
  check("STX M = TOF tavanı (148mm+gap → 0645)", ppla.includes(`${STX}M0645`));
  check("QR kaydı (1W1d = auto QR)", ppla.includes("1W1d"));
