 ...
 * dünyayı gösterdi:
 *   FIRM    (müşteri, fason): firma adı — eklentiler gürültüdür ("LTD ŞTİ" ↔ "A.Ş."),
 *           çekirdek karşılaştırılır; skor = max(Jaro-Winkler, token-sort).
 ...
 *           anlam taşır), iki ek koruma: numerik token'lar VE token SAYISI eşit; skor
 *           yalnız token-sort (Jaro-Winkler'in uzun ortak ön ek bonusu varyantları %93'e
 *           çıkarıyordu). Yazım/boşluk farkı (sıkıştırılmış metin eşit: "MİKRO CANVAS" ↔
 *           "MIKROCANVAS") her zaman %100 adaydır.
 */
...
/** Panel varsayılanı — yüzde. 90 = "neredeyse aynı". */
