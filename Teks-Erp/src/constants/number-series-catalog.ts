...
export const NUMBER_SERIES_CATALOG: readonly NumberSeriesCatalogEntry[] = [
  ...
  { key: "manifest", scopedCounter: { durum: "hazir", not: "Üreteç `nextSeriesNo` yolundan geçiyor (`nextManifestNo`, iki kaynak — iş emri dökümü + çuval çeki listesi — tek üreteç): kod listesi `formatChangedAt` damgasına göre süzülüyor ve çakışma atlaması aynı yerde (E2 depo-ticaret dilimi, 2026-09-23).", uretec: "services/helpers/manifest-number.helper.ts" }, panelGroup: "uretim", countTable: { model: "manifest", field: "manifestNo", birim: "belge" }, label: "Çeki listesi no", seedPrefix: "CL", seedDateSegment: D, seedDigits: 4, seedSeparator: "" },
  {
    key: "order",
