...
import stationRoutes, { machineRouter, machineHardwareRouter } from "./routes/station.routes";
...
import { printerModelRouter, labelFormatProfileRouter } from "./routes/printer.routes";
...
app.use("/api/machine-hardware", machineHardwareRouter);
app.use("/api/printer-models", printerModelRouter);
