...
| `docs/ops/PM2-GECIS-DEVIR-NOTU.md` | pm2'ye geçişin devir notu — runbook onu "deploy talimatı ve doğrulama listesi" olarak işaret ediyor |
...
- `docs/ops/PM2-GECIS-DEVIR-NOTU.md` ve `URETIM-KONTROL-LISTESI.md` (tam metin) — deploy doğrulama listesi.
