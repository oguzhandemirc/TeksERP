...
- **A2/A3 (ayrı tanım):** panel mal kabul lot alanı + Leventler lot kolonu + Ayarlar devere kategorisi (`devereLotRequired`) · tablet sarım formunda lot seçici (bağlam ucu allowlist genişler). Sürüm maddesi A2 ile (A1 operatöre görünür yüzey açmaz).
