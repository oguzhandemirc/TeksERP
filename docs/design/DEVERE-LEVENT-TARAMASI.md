...
- **E3 TABLET — SIRADA (ayrı sha):** Devere ekranı "Tezgahta" sekmesi (Tak, `mobile:devere`) · Dokuma ekranı "Levent" paneli (Sök/Tüket/Bitir, `mobile:dokuma`) · tablet-context `+loomMachines` + iki bayrak (allowlist `map`) · tablet sürüm maddesi.
