...
- **A3 (ayrı sha, tanım onaylı):** tablet sarım formunda lot seçici; `tablet-context` +`yarnLots`/+`lotRequired` (allowlist); "Lot yok" etiketi açık; kapalıyken form bayt bayt eski.
