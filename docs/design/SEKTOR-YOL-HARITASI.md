...
| 🔵 | **Fasona verilen yardımcı malzeme / bileşen defteri (boya, ki…** | Fasoncuya kumaş DIŞINDA verilen hiçbir şey kayda giremiyor: boya/kimyasal, konfeksiyonda aksesuar (düğme, fermuar, etiket, karton), örme/dokuma fason… | Hiç yok. SubcontractorDispatchItem.rollId NOT NULL (schema.prisma:3686) — sevk kalemi yapısal olarak yalnız b… | sektör geneli |
