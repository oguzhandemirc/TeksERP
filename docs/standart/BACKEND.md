...
## 5 · Zarf ve hata şekli → [`BACKEND-HTTP.md`](BACKEND-HTTP.md)
...
## 8 · Kapılar → [`BACKEND-HTTP.md`](BACKEND-HTTP.md)

## 9 · Zod → [`BACKEND-HTTP.md`](BACKEND-HTTP.md)

## 10 · Swagger → [`BACKEND-HTTP.md`](BACKEND-HTTP.md)
