...
|  | § Kapsam, ölçümün İÇİNE değil YANINA yazılır | (`OLCUM-DISIPLINI.md`) |
...
|  | § Aracın DOĞRU cevap verdiği koşum, onu DOĞRULAMAZ — yanlış demesi gereken yerde sına | (`OLCUM-DISIPLINI-ARAC.md`) |
