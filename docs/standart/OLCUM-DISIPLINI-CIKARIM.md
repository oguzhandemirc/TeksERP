...
liste bir iş tanımı değil bir arama çıktısıdır. Yakın akrabaları: KATMAN 1 `OLCUM-DISIPLINI-YUKLEM.md` § Dolaylılık ve `OLCUM-DISIPLINI.md` § Teşhis mesajı da bir yüklemdir.
