...
| [`OLCUM-DISIPLINI-SINIRSIZ.md`](OLCUM-DISIPLINI-SINIRSIZ.md) | § Sınırsız eşleşme'nin **vaka envanteri** — her vakanın korpusu, paydası, kapsam beyanı; kural ve tablo `-YUKLEM.md`'de kalır |
...
| [`OLCUM-DISIPLINI-DIZIN.md`](OLCUM-DISIPLINI-DIZIN.md) | **BAŞLIK DİZİNİ** — ölçüm disiplini dosyalarının her başlığı tek tabloda; *"bu zaten hangi başlığın altında?"* sorusunun `grep`siz cevabı. Her satır bir çapadır, iki yönden de kapı altındadır |
