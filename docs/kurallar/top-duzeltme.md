...
- **[ÇEKİRDEK]** Metraj geri koyma İKİ DALDA AYNI KURAL: kesim (cutOpenFabric da cutWarehouseRoll da) yalnız currentQty düşürür, initialQty üretim anı snapshot'ıdır ve DOKUNULMAZ (2026-08-29, tambur.service:2316 şerhi); geri alma her dalda currentQty'yi geri koyar ve initialQty'yi yalnız AŞIMDA yukarı çeker (initialBump = max(0, yeniCurrent − initial)) + OVERAGE/TAMBUR_UNDO_RESTORE sapma satırı — düz +len şişirir. · bekçi: `test_tambur_undo §5 + §11 (§11 üretim dalını ölçer; depo dalı ÖLÇÜLMÜYOR)` · Kapanır: `tambur-undo.service :1256-1264 ve :1465-1475 initialBump desenine geçip test_stock_ledger_tambur_undo §12 (depo kesimi geri alınınca initialQty 100→100, aşımda bump + OVERAGE) yeşil verince — ölçüldü 2026-09-13: fabrika kopyasında geri alınmış depo kesimi 0, saha etkisi yok` · Çapa: `test_stock_ledger_tambur_undo` · Öncül: ölçüldü <sub>(CLAUDE.md:58, CLAUDE.md:81; arşiv 2026-08-29 BULGU-T2-016)</sub>
