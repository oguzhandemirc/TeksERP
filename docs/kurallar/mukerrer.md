...
- **[ÇEKİRDEK]** Canlı referanslı ana veri pasife ALINMAZ (MV-06): ürün · renk · özellik · müşteri · depo · fasoncu arşivi 409 + engelleyen kayıtlar tek tek döner, "uyar ama bırak" yazılmaz; çıkış yolu kaydı kapatmak, birleştirmek ya da ürün kartında "Tükenene kadar"dır. Stoktaki/çuvaldaki/sevkiyattaki kartela ürün ve renk için canlı referanstır (S4). · bekçi: `test_item_archive_gate`, `test_master_data_archive_gate`, `test_kartela_arsiv_kapisi` <sub>(arşiv:2026-09-25; S4 2026-09-26)</sub>
