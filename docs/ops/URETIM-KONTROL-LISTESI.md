...
- [ ] **Backend testleri yeşil** — `Teks-Erp/` içinde `npm test`
      (= `tsx scripts/run-all-tests.ts`, 47 adet `test_*.ts` dosyası) exit 0.
...
- [ ] **`migrate deploy` provası yapıldı** — temiz bir DB'de (`teks_deploy_probe`
      gibi) tüm migration'lar hatasız uygulanıyor (son prova 2026-06-13:
      **51/51 hatasız**, bkz. `Teks-Erp/MIGRATION-DEPLOY.md`).
