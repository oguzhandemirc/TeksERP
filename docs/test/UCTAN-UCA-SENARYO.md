...
|---|---|---|---|---|
| Ana zincir A–M (panel) | 43 | 29 (A1 · B1–B4 · C1–C8 · D0 · E1–E3 · F1 · G1 · I4 · J1 · I7 · J2–J5 · M1–M3 [her biri 3 alt adım: kapat S · ölç P · aç S] — ~10 dk; roller S · P · M; koşum sırası I4 → J1 → I7 → N6 → J2 → J3 → J4 → J5 → M1 → M3 → M2; **TESTL tam koşum 2026-09-18: 24 yeşil · 1 kırmızı (N6 = İHLAL); J4/J5 · M1–M3 ayrıca yeşil**) | 5 | 9 (belge önizleme, yazıcı, Wi-Fi, Excel/PDF) |
