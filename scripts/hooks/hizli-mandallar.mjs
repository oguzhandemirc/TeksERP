...
//    edinen 12'si burada (+13. `belge_capa_atfi` · 14. `gun_anahtari_kaynagi` · 15. `yerel_ayar_bagimliligi` · 16. `harita_sonda_atfi` · 17. `fikstur_sabit_ad` · 18. `lookup_beyan_aynasi`, 2026-09-14). Küme ELLE listelenir — "scripts/ altında DB'siz olan
