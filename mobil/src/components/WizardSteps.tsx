...
// =============================================================================
// Adım şeridi — çok adımlı sihirbazların ortak başlığı (Hızlı İş Emri, Yeni
// Sipariş). Önce `HizliIsEmri/wizard/WizardSteps.tsx` içinde sabit üç başlıkla
// yaşıyordu; ikinci sihirbaz gelince başlıklar prop'a çıkarıldı. Görsel çıktı
// birebir korundu (ölçüler/renkler değişmedi) — o dosya artık buraya delege eder.
//
// Sözleşme: GERİDE KALAN adıma dokunarak dönülebilir, İLERİ atlanamaz. İleri
// gidiş yalnız ekranın "Devam" butonundan olur, çünkü ilerlemenin ön koşulunu
// (o adımda karar verilmesi gereken şey) yalnız ekran bilir.
// =============================================================================

interface Props {
  /** Adım başlıkları — 2..4 arası pratik (dar telefonda 4'ten sonra kırpılır). */
  titles: readonly string[];
  /** Aktif adım, 0-tabanlı. */
  current: number;
  onGoTo: (index: number) => void;
}

export default function WizardSteps({ titles, current, onGoTo }: Props) {
  return (
