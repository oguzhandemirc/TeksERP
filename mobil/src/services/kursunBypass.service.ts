...
// `KursunBypassVisibility` (menü sayaçları) 2026-08-05'te KALDIRILDI: "Kurşun
// Dağıtım" karosu artık bayrak/sayaçtan bağımsız, yalnız `mobile:kursun-dagitim`
// iznine bağlı (bkz. hooks/useVisibleScreens). Backend ucu duruyor — sahadaki
// ESKİ APK'lar onu hâlâ çağırıyor, silinseydi deploy penceresinde 404 alırlardı.
