...
export const tamburService = {
  ...
  cutWarehouseRoll: (
    rollId: string,
    data: { cutLength: number; qualityGrade?: string | null; notes?: string | null; targetOrderLineId?: string | null; targetCustomerId?: string | null; markedForKartela?: boolean; rawDestination?: 'STOCK' | 'WAREHOUSE'; clientChildBarcode?: string }
