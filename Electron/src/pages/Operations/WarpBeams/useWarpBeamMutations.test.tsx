// =============================================================================
// BEKÇİ — Levent planla/düzenle: başarı mesajı SUNUCUDAN, uyarı kancada ÇİFT basılmaz
// =============================================================================
// Kullanıcı bulgusu (2026-09-18): aynı gövde no'lu planlar sessizce kaydediliyor, hata sarımda çıkıyordu. Backend
// artık plan anında uyarır; uyarılar apiClient interceptor'ında genel basılır (S1b SINIR, 2026-09-25 — ölçümü
// apiClient.test "sunucu uyarıları"). Kanca yalnız başarı tostunu basar; uyarıyı da basarsa kullanıcı iki kez görür.
...
describe("useWarpBeamMutations — K5b plan anı uyarıları", () => {
  it("① ⭐ planla: başarı toast'ı sunucu mesajıyla, uyarılar kancada ÇİFT basılmaz, onDone çağrılır", async () => {
