...
/**
 * Fasondan Doğrudan Sevk (DirectShipment) detayı — birleşik Sevkiyatlar listesinden
 * "Fasondan Doğrudan" satırı açılınca. Toplar + karşılanan siparişler + fason/İE
 * bağlamı; "İrsaliye" ile resmi belge (SUBCONTRACTOR_DIRECT_SHIP) yazdırılır.
 */
