 ...
 * bunu kullanır: Çuval Depo kartı, Okutarak Sevk, Paketleme footer'ı. CLAUDE.md
...
export function DispatchConfirmDialog({ shipment, onOpenChange, onDispatched, scannedCodes }: Props) {
  ...
  const isScanned = (sack: { sackNo: string; manualCode: string | null }) =>
    ...
    (sack.manualCode ? scannedSet.has(norm(sack.manualCode)) : false);
      ...
      <DialogContent className="max-h-[90vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            içindeki topların stoğu <strong>düşecek</strong> ve bu işlem{" "}
            <strong>geri alınamaz</strong>. Aşağıdaki çuvalların yüklendiğini doğrulayın.
          </DialogDescription>
        </DialogHeader>
