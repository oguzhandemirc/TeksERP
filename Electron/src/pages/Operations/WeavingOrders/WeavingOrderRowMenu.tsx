import { Pencil, CheckCircle2, Ban } from "lucide-react";
...
/** Satır menüsü — üç eylem de yalnız AÇIK durumda ve `weavingorder:write` ile. */
export function WeavingOrderRowMenu({ row, onEdit, onClose, onCancel }: Props) {
